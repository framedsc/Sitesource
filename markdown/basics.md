...
For Unity, the [UnityExplorer](https://github.com/sinai-dev/UnityExplorer) project by sinai-dev adds a freecam and much more to most Unity games. Please visit our [guide](./GeneralGuides/universal_unity_freecam.htm) for more information how to use it.
